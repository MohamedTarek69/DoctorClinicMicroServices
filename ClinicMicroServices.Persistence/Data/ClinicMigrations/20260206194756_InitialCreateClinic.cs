...
{
    /// <inheritdoc />
    public partial class InitialCreateClinic : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClinicName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimeSlots_DoctorClinics_ClinicId",
                        column: x => x.ClinicId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_DoctorClinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "DoctorClinics",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeSlots_ClinicId_StartTime_EndTime",
                table: "TimeSlots",
                columns: new[] { "ClinicId", "StartTime", "EndTime" });
        }
